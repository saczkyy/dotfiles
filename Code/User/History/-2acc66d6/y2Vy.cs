...
public class balin : MonoBehaviour
{
    ...
    static class Line{
        static void DrawLine2points(Vector2 start, Vector2 end, float width, Color color){
        ...
        static GameObject DrawLineStartLength(Vector2 start, float angle, float radius, float width, Color color){
            GameObject line = new GameObject("Line");
