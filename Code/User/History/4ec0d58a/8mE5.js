...
async function spawnStar(x= Math.random() * max_x, y = Math.random() * max_y, falling=false){
...
function spawnFallingStar(){
    ...
    async function showStar(){
        ...
        for (let i=0; i < number_of_steps; i++){
            ...
            var new_star = await spawnStar(x, y, true)
            new_star.classList.add('getReal')
