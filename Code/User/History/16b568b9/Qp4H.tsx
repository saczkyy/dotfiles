...
import { useStyles } from "./PhysicalFormScreen.styles";
...
import { availableRemainderTimeIntervals } from "./PhysicalFormScreen.consts";
...
export const PhysicalFormScreen = () => {
  ...
  const handleNextPress = () => {
    ...
    if (customTimeInterval === "" && reminderTimeIntervalSetting !== "more")
      return `Answer: ${answer}, reminder settings: ${reminderTimeIntervalSetting}`;
    if (customTimeInterval !== "") {
      return `Answer: ${answer}, reminder settings: ${customTimeInterval}`;
    }
    ...
    <View>
      ...
      <View style={styles.answersWrapper}>
        ...
        >
          <View style={styles.cardWrapper}>
            ...
            <UnpressableRadioButton
              value="yes"
              isChecked={answer === "yes" ? "checked" : "unchecked"}
            />
          </View>
        </ClickableOutlinedCard>
        <ClickableOutlinedCard
        ...
        >
          <View style={styles.cardWrapper}>
            ...
            <UnpressableRadioButton
              value="no"
              isChecked={answer === "no" ? "checked" : "unchecked"}
            />
          </View>
        </ClickableOutlinedCard>
      </View>
      ...
      <View style={styles.buttonWrapper}>
        ...
        <Button
          ...
          onPress={() => console.log(handleNextPress())}
        >
          Next
        </Button>
      </View>
