...
from widgets import battery, menu_popup
import themes 
...
keys = [
    ...
    Key([mod, "shift"], "q", lazy.function(menu_popup.show_power_menu)),
    ...
    Screen(
        bottom=bar.Bar(
            [   
                ...
                widget.TextBox(
                    font='Noto Nerd Font',
                    mouse_callbacks={'Button1': lambda: qtile.cmd_function(menu_popup.show_power_menu)},
